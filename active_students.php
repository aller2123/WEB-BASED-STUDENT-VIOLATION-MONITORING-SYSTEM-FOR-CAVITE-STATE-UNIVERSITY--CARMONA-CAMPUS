...
<style>
        ...
        h2 {
            ...
            margin-bottom: 20px; /* Add some bottom margin to separate from the table */
        }
        /* PRINT CSS */
        @media print {
...
<body>
    <div class="container mt-4">
        <h2 class="mb-3">Enrolled Students by Program</h2>
        <div class="row mb-3">
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        <a href="javascript:history.back()" class="btn btn-outline-secondary ml-1">
    ...
    <div class="col-md-4 text-right">
        ...
        <header id="printHeader" class="d-none d-print-block">
            ...
            <h1 id="printHeader" class="d-none d-print-block text-center mb-4">Active Student Records</h1>
        </header>
