...
$whereConditions = ['students.status = "Enrolled"'];
$params = [];
...
$sql = "SELECT students.*, program.program_name, 
        ...
        WHERE students.is_archived = 0 AND students.status = 'Enrolled'";
...
// Calculate total enrolled students for pagination
$totalStudentsSQL = "SELECT COUNT(*) FROM students WHERE is_archived = 0 AND status = 'Enrolled'";
$totalStudentsParams = [];
...
$noResultMessage = (empty($students)) ? 'No enrolled students found.' : '';

// Include the rest of your HTML structure from student.php, but update the title and headers to reflect "Enrolled Students"
?>
...
<aside id="sidebar">
    ...
    <ul class="collapse list-unstyled" id="studentSubmenu">
        ...
        <li>
            <a href="enrolled_students.php" class="nav-link active">Enrolled</a>
        </li>
        <li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="counselingSubmenu">
        ...
        <li>
            <a href="violation.php" class="nav-link">
                Violations
            </a>
        </li>
