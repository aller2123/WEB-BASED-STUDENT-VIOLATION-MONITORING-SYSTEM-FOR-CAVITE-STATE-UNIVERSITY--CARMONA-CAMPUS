...
if (!isset($_GET['student_id']) || empty(trim($_GET['student_id']))) {
    // Handle form submission for updating or creating a requirements row
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['student_id'])) {
        ...
        try {
            // Check if the student_id already exists in the requirements table
            $checkSql = "SELECT COUNT(*) FROM requirements WHERE student_id = :student_id";
            ...
            if ($rowCount > 0) {
                ...
                $updateSql = "UPDATE requirements SET req1 = :req1, req2 = :req2, req3 = :req3, clearance_status = :clearance_status 
                ...
                // Insert a new row into the requirements table
                $insertSql = "INSERT INTO requirements (student_id, req1, req2, req3, clearance_status) 
                              VALUES (:student_id, :req1, :req2, :req3, :clearance_status)";
                ...
                $_SESSION['success_message'] = "New requirements added successfully.";
            }
