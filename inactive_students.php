...
$notEnrolledByProgramStmt = $pdo->query("SELECT program.program_name, COUNT(students.student_id) AS student_count 
                                    FROM students 
                                    JOIN program ON students.program_id = program.program_id 
                                    WHERE students.status = 'Not Enrolled' 
                                    GROUP BY program.program_name");

$notEnrolledByProgram = $notEnrolledByProgramStmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<div class="container mt-4">
    <h2 class="mb-3">Not enrolled Students by Program</h2>
    <div class="row mb-3">
        <div class="col-md-4">
    ...
    <header id="printHeader" class="d-none d-print-block">
                ...
                <h1 id="printHeader" class="d-none d-print-block text-center mb-4">Not Enrolled Records</h1>
            </header>
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php foreach ($notEnrolledByProgram as $program): ?>
                    <tr>
