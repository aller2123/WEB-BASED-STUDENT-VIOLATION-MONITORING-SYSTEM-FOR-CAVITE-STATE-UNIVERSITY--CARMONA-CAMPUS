...
$whereConditions = ['students.status = "Graduate"'];
$params = [];
...
$sql = "SELECT students.*, program.program_name, 
        ...
        COALESCE(students.created_at, NOW()) AS enrollment_date 
        FROM students 
        LEFT JOIN program ON students.program_id = program.program_id
        WHERE students.is_archived = 0 AND students.status = 'Graduate'";
...
// Calculate total graduate students for pagination
$totalStudentsSQL = "SELECT COUNT(*) FROM students WHERE is_archived = 0 AND status = 'Graduate'";
$totalStudentsParams = [];
...
<aside id="sidebar">
    ...
    <ul class="collapse list-unstyled" id="studentSubmenu">
        ...
        <li>
            <a href="graduate_students.php" class="nav-link active">Graduate</a>
        </li>
    </ul>
</li>
